...
/bin/autossh -M \$MONITOR_PORT -o \"ServerAliveInterval 10\" -o \"ServerAliveCountMax 3\" -o \"TCPKeepAlive yes\" -o \"ExitOnForwardFailure yes\" -o \"ConnectTimeout 15\" -N -R \$TUNNEL_LISTEN_PORT:localhost:\$CURRENT_LISTEN_PORT root@\$TUNNEL_IP -p \$TUNNEL_SSH_PORT" > "$REVERSE_TUNNEL_BASHFILE_PATH"
